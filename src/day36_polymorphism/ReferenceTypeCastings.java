...
public class ReferenceTypeCastings {
    ...
    public static void main(String[] args) {
        ...
        ( (Dog)animal1 ).bark(); // down castings

        // Dog dog1 = (Dog)animal1; // down castings
        // dog1.bark();

        // ( (Cat) animal1).scratch(); // Dog can not be converted the cat, because there is not "IS A" relationship between dog and car
