...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        String s1 = "" + true; // "" double quote transform this boolean method to String method "true"
        String s2 = "" + 'E'; // "e"
    ...
    public static String combine(String str1, String str2) {
       ...
       /* if (str1.endsWith("" + str2.charAt(0))) { // first string ends with the first character of second string
