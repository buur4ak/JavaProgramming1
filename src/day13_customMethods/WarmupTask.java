...
Specifier:Static,(Static: can be called the through the class name) -final-abstract-synchronized
Return-Type:void (does not return any value), any dataType
