...
public class SetDemo {
    ...
    public static void main(String[] args) {
        ...
        Set<Integer> set2 = new LinkedHashSet<>(); // Keeps insertion order, does not accept null key
        ...
        numbers.addAll(Arrays.asList(10,10,10,20,20,30,30,30,30,40,40,40,50,50,50,5,5,5,1,1,1,2,2,2));
